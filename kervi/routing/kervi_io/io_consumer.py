...
class _IOConsumerChannel(object):
    ...
    """
    #EXCHANGE = 'api_key_1_exchange'
    #EXCHANGE_TYPE = 'topic'
    #QUEUE = 'KIO_router_1'
    #ROUTING_KEY = 'xevent:.*'

    def __init__(self, connection, router, exchange, queue):
    ...
    def on_queue_declareok(self, method_frame):
        ...
        """
        self._channel.queue_bind(self.on_bindok, self._queue, self._exchange, "ping")
        self._channel.queue_bind(self.on_bindok, self._queue, self._exchange, "*." + self._router._connection_id + ".*")
    ...
    def on_message(self, unused_channel, basic_deliver, properties, body):
        ...
        if basic_deliver.routing_key == "ping":
            ...
            self._router.on_message(properties.headers, json_body)
