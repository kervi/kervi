...
class _IOPublisherChannel(object):
    ...
    def __init__(self, connection, exchange, router):
    ...
    def schedule_ping(self):
        ...
        self._connection.add_timeout(5, self.publish_ping)
    ...
    def publish_ping(self):
        ...
        hdrs = {
            "connection_id": self._router._connection_id
        }
